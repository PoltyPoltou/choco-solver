...
import org.chocosolver.solver.constraints.nary.knapsack.innernode.InnerNodeMaxWeight;

public class InnerNodeMaxWeightFactory extends InnerNodeFactory {

    public InnerNode createInnerNode() {
        return new InnerNodeMaxWeight();
    }
