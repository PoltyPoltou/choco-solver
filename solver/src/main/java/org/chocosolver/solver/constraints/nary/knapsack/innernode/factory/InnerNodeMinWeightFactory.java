...
import org.chocosolver.solver.constraints.nary.knapsack.innernode.InnerNodeMinWeight;

public class InnerNodeMinWeightFactory extends InnerNodeFactory {

    public InnerNode createInnerNode() {
        return new InnerNodeMinWeight();
    }
